object Acc{
 def main(args:Array[String])={
  ...
  new Account("4560910V",1000,2390.50),
  new Account("2983774V",1001,-120.80),
  new Account("0923748V",1002,50000.0),
  new Account("1292844V",1003,3034.90),
  new Account("5134134V",1004,-290.00),
  new Account("9237428V",1005,65332.70)
  ) 
